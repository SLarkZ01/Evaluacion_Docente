                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            <div class="d-flex align-items-center p-3 quick-access-card">
                                ...
                                <a href="roles-permisos.html" class="ms-auto btn btn-sm btn-outline-primary">Ir</a>
                            </div>
                        </div>
                        <div class="col-md-4 mb-3">
                            <div class="d-flex align-items-center p-3 quick-access-card">
                                ...
                                <a href="periodos-evaluacion.html" class="ms-auto btn btn-sm btn-outline-primary">Ir</a>
                            </div>
                        </div>
                        <div class="col-md-4 mb-3">
                            <div class="d-flex align-items-center p-3 quick-access-card">
                                ...
                                <a href="reportes-admin.html" class="ms-auto btn btn-sm btn-outline-primary">Ir</a>
                            </div>
                        </div>
                    </div>
                </div>
